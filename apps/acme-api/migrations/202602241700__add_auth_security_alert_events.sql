-- Add auth security alert event storage.
--
-- This is intentionally idempotent because the current baseline migration also
-- creates the same table for fresh local databases.
