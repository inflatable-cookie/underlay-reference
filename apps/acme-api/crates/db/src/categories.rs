...
pub async fn list_categories(
    ...
    let mut query_builder = sqlx::query_as::<_, CategoryRow>(sqlx::AssertSqlSafe(sql));
...
pub async fn list_categories_with_counts(
    ...
    let mut query_builder = sqlx::query_as::<_, CategoryWithCountsRow>(sqlx::AssertSqlSafe(sql));
    for value in filter_values {
        query_builder = query_builder.bind(value);
    }
