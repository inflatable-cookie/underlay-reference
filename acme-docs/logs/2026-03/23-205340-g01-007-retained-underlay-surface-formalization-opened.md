---
title: g01.007 retained Underlay surface formalization opened
status: completed
owner: Platform
updated: 2026-03-23
tags: [planning, roadmap, poodle, underlay, acme-admin, g01.007]
---

## Summary

Opened `g01.007` as the next post-proof milestone after the completion of `g01.006`.
...
- `g01.006` already proved the Poodle/Underlay coexistence model in `acme-admin`.
- The next useful decision is not another residue hunt; it is freezing the boundary of what still belongs in Underlay after that proof.
- That retained-surface contract is the dependency that downstream app rollouts need next.
