...
- Use `~/Dev/projects/underlay-reference/acme-admin/src/routes/+layout.svelte` as the theme ownership entrypoint.
- Use `~/Dev/projects/underlay-reference/acme-admin/src/routes/(app)/+page.svelte` as the first page-level replacement target.
...
- [~/Dev/projects/underlay/contracts/ui/poodle-underlay-coexistence-contract.json](~/Dev/projects/underlay/contracts/ui/poodle-underlay-coexistence-contract.json)
...
- [~/Dev/projects/underlay-reference/acme-docs/roadmaps/g01/006-poodle-underlay-coexistence-proof.md](~/Dev/projects/underlay-reference/acme-docs/roadmaps/g01/006-poodle-underlay-coexistence-proof.md)
- [~/Dev/projects/underlay-reference/acme-admin/package.json](~/Dev/projects/underlay-reference/acme-admin/package.json)
- [~/Dev/projects/underlay-reference/acme-admin/src/routes/+layout.svelte](~/Dev/projects/underlay-reference/acme-admin/src/routes/+layout.svelte)
- [~/Dev/projects/underlay-reference/acme-admin/src/routes/(app)/+layout.svelte](~/Dev/projects/underlay-reference/acme-admin/src/routes/(app)/+layout.svelte)
- [~/Dev/projects/underlay-reference/acme-admin/src/routes/(app)/+page.svelte](~/Dev/projects/underlay-reference/acme-admin/src/routes/(app)/+page.svelte)
- [~/Dev/projects/poodle/docs/guides/svelte-developer-guide.md](~/Dev/projects/poodle/docs/guides/svelte-developer-guide.md)

## Constraints

- Follow the repo instructions in `~/Dev/projects/underlay-reference/AGENTS.md`.
...
- [~/Dev/projects/underlay-reference/acme-admin/src/routes/+layout.svelte](~/Dev/projects/underlay-reference/acme-admin/src/routes/+layout.svelte)
- [~/Dev/projects/underlay-reference/acme-admin/src/routes/(app)/+page.svelte](~/Dev/projects/underlay-reference/acme-admin/src/routes/(app)/+page.svelte)
- [~/Dev/projects/underlay-reference/acme-admin/svelte.config.js](~/Dev/projects/underlay-reference/acme-admin/svelte.config.js)
- [~/Dev/projects/underlay-reference/acme-admin/src/lib/poodle/composites.ts](~/Dev/projects/underlay-reference/acme-admin/src/lib/poodle/composites.ts)
- [~/Dev/projects/underlay-reference/acme-admin/src/lib/poodle/primitives.ts](~/Dev/projects/underlay-reference/acme-admin/src/lib/poodle/primitives.ts)
- [~/Dev/projects/underlay-reference/acme-admin/src/lib/poodle/runtime.ts](~/Dev/projects/underlay-reference/acme-admin/src/lib/poodle/runtime.ts)
- [~/Dev/projects/underlay-reference/acme-docs/logs/2026-03/23-155042-acme-admin-poodle-underlay-coexistence-proof.md](~/Dev/projects/underlay-reference/acme-docs/logs/2026-03/23-155042-acme-admin-poodle-underlay-coexistence-proof.md)
...
- `~/Dev/projects/underlay-reference/acme-admin/src/routes/(app)/+page.svelte` replaces at least one existing Underlay primitive or generic composite with direct Poodle usage.
...
3. If the proof changes the Underlay migration posture, update `~/Dev/projects/underlay/contracts/ui/poodle-underlay-coexistence-contract.json`.
