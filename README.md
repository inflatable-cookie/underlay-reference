...
(`v0.9.10` at time of writing), not from sibling source paths.
...
```json
"@inflatable-cookie/underlay": "git+ssh://git@github.com/inflatable-cookie/underlay.git#v0.9.10"
```

```toml
underlay-core = { git = "ssh://git@github.com/inflatable-cookie/underlay.git", tag = "v0.9.10" }
```

Poodle core/Svelte packages resolve from the public npm registry at `0.4.2`.
